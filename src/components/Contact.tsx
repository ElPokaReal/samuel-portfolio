  ...
  return (
    <section className="py-20 md:py-32 pb-40 md:pb-48 text-center" id="contact">
      <div className="px-4">
        ...
        <button
          className="group relative inline-flex items-center justify-center overflow-hidden px-8 py-3 font-bold text-black transition-all duration-300 hover:text-black bg-primary cartoon-border cartoon-shadow cartoon-shadow-hover cursor-pointer"
          onClick={() => window.location.href = 'mailto:samuaranguren@gmail.com'}
        >
